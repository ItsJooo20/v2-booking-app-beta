...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <h1 class="h3 mb-0">Edit Kategori Fasilitas</h1>
            ...
            <form action="{{ route('facility-categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="file"
                           ...
                           accept="image/*">
                    <div class="form-text">
                        Unggah gambar baru untuk mengganti (JPEG, PNG, JPG, GIF, maks 2MB)
                    </div>
                    @error('image')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input @error('requires_return') is-invalid @enderror"
                               ...
                               value="1"
                               {{ old('requires_return', $category->requires_return) ? 'checked' : '' }}>
