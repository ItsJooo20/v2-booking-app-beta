...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Create Facility Item</h2>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('facility-items.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select @error('facility_id') is-invalid @enderror" id="facility_id" name="facility_id" required>
                        ...
                        @foreach($facilities as $facility)
                            <option value="{{ $facility->id }}" {{ old('facility_id', request('facility_id')) == $facility->id ? 'selected' : '' }}>
